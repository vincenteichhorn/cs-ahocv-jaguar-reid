#!/bin/bash -eux
#SBATCH --job-name=lbe04b_augmentation_trainable
...
#SBATCH --output /sc/home/vincent.eichhorn/jaguar-reid/_jobs/job_lbe04b_augmentation_trainable-%j.log

export PATH="/sc/home/vincent.eichhorn/conda3/bin:$PATH"
cd /sc/home/vincent.eichhorn/jaguar-reid
poetry install 
poetry run python -m jaguar.experiments.lbe04b_augmentation_trainable