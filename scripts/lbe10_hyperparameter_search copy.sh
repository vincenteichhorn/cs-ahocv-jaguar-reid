...
#SBATCH --output /sc/home/vincent.eichhorn/jaguar-reid/_jobs/job_lbe10_hyperparameter_search-%j.log

export PATH="/sc/home/vincent.eichhorn/conda3/bin:$PATH"
cd /sc/home/vincent.eichhorn/jaguar-reid
poetry install 
poetry run python -m jaguar.experiments.lbe10_hyperparameter_search