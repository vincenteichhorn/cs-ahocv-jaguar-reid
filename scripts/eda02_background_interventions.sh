#!/bin/bash -eux
#SBATCH --job-name=eda02_background_interventions
...
#SBATCH --output /sc/home/vincent.eichhorn/jaguar-reid/_jobs/job_eda02_background_interventions-%j.log

export PATH="/sc/home/vincent.eichhorn/conda3/bin:$PATH"
cd /sc/home/vincent.eichhorn/jaguar-reid
poetry install 
poetry run python -m jaguar.experiments.eda02_background_interventions