#!/bin/bash -eux
#SBATCH --job-name=09a_augmentation_frozen
...
#SBATCH --output /sc/home/vincent.eichhorn/jaguar-reid/_jobs/job_09a_augmentation_frozen-%j.log

export PATH="/sc/home/vincent.eichhorn/conda3/bin:$PATH"
cd /sc/home/vincent.eichhorn/jaguar-reid
poetry install 
poetry run python -m jaguar.experiments.09a_augmentation_frozen