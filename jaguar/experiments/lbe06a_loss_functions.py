...
from jaguar.criteria import ArcFaceCriterion, CosFaceCriterion, FocalArcFaceCriterion, SubCenterArcFaceCriterion, TripletCriterion
...
for criterion_name in ["Triplet", "ArcFace", "SubCenterArcFace", "FocalArcFaceCriterion", "CosFace"]:
    ...
    critera_config = {
        "Triplet": {"triplet_margin": 0.3},
        "ArcFace": {"arcface_embedding_dim": EXPERIMENT_CONFIG["output_dim"], "num_classes": num_classes, "arcface_margin": 0.5, "arcface_scale": 64.0},
        "SubCenterArcFace": {
            "subc_arcface_embedding_dim": EXPERIMENT_CONFIG["output_dim"],
            "num_classes": num_classes,
            "subc_arcface_num_subcenters": 3,
            "subc_arcface_margin": 0.5,
            "subc_arcface_scale": 64.0,
        },
        "FocalArcFaceCriterion": {
            "focal_arcface_embedding_dim": EXPERIMENT_CONFIG["output_dim"],
            "num_classes": num_classes,
            "focal_arcface_margin": 0.5,
            "focal_arcface_scale": 64.0,
            "focal_gamma": 2.0,
        },
        "CosFace": {"cosface_embedding_dim": EXPERIMENT_CONFIG["output_dim"], "num_classes": num_classes, "cosface_margin": 0.35, "cosface_scale": 64.0},
    }
    EXPERIMENT_CONFIG = {**EXPERIMENT_CONFIG, **critera_config[criterion_name]}

    criteria = {
        "Triplet": lambda: TripletCriterion(margin=EXPERIMENT_CONFIG["triplet_margin"]),
        "ArcFace": lambda: ArcFaceCriterion(
            embedding_dim=EXPERIMENT_CONFIG["arcface_embedding_dim"],
            num_classes=EXPERIMENT_CONFIG["num_classes"],
            margin=EXPERIMENT_CONFIG["arcface_margin"],
            scale=EXPERIMENT_CONFIG["arcface_scale"],
        ),
        "SubCenterArcFace": lambda: SubCenterArcFaceCriterion(
            embedding_dim=EXPERIMENT_CONFIG["subc_arcface_embedding_dim"],
            num_classes=EXPERIMENT_CONFIG["num_classes"],
            num_subcenters=EXPERIMENT_CONFIG["subc_arcface_num_subcenters"],
            margin=EXPERIMENT_CONFIG["subc_arcface_margin"],
            scale=EXPERIMENT_CONFIG["subc_arcface_scale"],
        ),
        "FocalArcFaceCriterion": lambda: FocalArcFaceCriterion(
            embedding_dim=EXPERIMENT_CONFIG["focal_arcface_embedding_dim"],
            num_classes=EXPERIMENT_CONFIG["num_classes"],
            margin=EXPERIMENT_CONFIG["focal_arcface_margin"],
            scale=EXPERIMENT_CONFIG["focal_arcface_scale"],
            gamma=EXPERIMENT_CONFIG["focal_gamma"],
        ),
        "CosFace": lambda: CosFaceCriterion(
            embedding_dim=EXPERIMENT_CONFIG["cosface_embedding_dim"],
            num_classes=EXPERIMENT_CONFIG["num_classes"],
            margin=EXPERIMENT_CONFIG["cosface_margin"],
            scale=EXPERIMENT_CONFIG["cosface_scale"],
        ),
    }
