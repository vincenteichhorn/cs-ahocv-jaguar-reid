...
from jaguar.components import DINOv3, EfficientNetB4, MegaDescriptor, MobileNetV3, VielleichtguarModel, EmbeddingProjection
...
for backbone, image_size in [
    ...
    RUN_NAME = f"{GROUP}-{backbone.__class__.__name__.lower()}-projection-arcface"
