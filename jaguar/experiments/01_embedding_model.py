...
from jaguar.embedding_models import MegaDescriptor, DINOv3, EfficientNetB4, MobileNetV3
...
embedding_models = [DINOv3(device=device), MegaDescriptor(device=device), EfficientNetB4(device=device), MobileNetV3(device=device)]
